...
VIM_MODULE(pathogen      , https://github.com/tpope/vim-pathogen.git)
VIM_MODULE(fugitive      , https://github.com/tpope/vim-fugitive.git)
VIM_MODULE(ctrlp         , https://github.com/kien/ctrlp.vim.git)
VIM_MODULE(jellybeans    , https://github.com/nanotech/jellybeans.vim.git)
VIM_MODULE(surround      , https://github.com/tpope/vim-surround.git)
VIM_MODULE(gundo         , https://github.com/vim-scripts/Gundo.git)
VIM_MODULE(ack           , https://github.com/mileszs/ack.vim.git)
VIM_MODULE(gist          , https://github.com/vim-scripts/Gist.vim.git)
VIM_MODULE(align         , https://github.com/tsaleh/vim-align.git)
VIM_MODULE(markdown      , https://github.com/tpope/vim-markdown.git)
VIM_MODULE(repeat        , https://github.com/tpope/vim-repeat.git)
VIM_MODULE(unimpared     , https://github.com/tpope/vim-unimpaired.git)
